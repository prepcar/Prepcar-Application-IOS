...
#import "TermbuyerViewController.h"

@interface TermbuyerViewController ()

@end

@implementation TermbuyerViewController
...
-(void)aboutusmethod{
    NSString *urlString = @"http://autonana.com/admin/pages/terms";
