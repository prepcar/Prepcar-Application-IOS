...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _itemTitleColor = [UIColor colorWithRed:184/255.0 green:184/255.0 blue:184/255.0 alpha:1.0f];
        _itemSelectedTitleColor = [UIColor colorWithRed:0/255.0 green:17/255.0 blue:133/255.0 alpha:1.0f];
        _itemIndicatorColor = [UIColor colorWithRed:0/255.0 green:17/255.0 blue:133/255.0 alpha:1.0f];
