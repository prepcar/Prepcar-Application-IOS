...
- (void)initialiseControl {
    //defaults:
    _minValue = 1990;
    _selectedMinimum = 1990;
    _maxValue = 2017;
    _selectedMaximum  = 2017;
...
- (NSNumberFormatter *)decimalNumberFormatter {
    if (!_decimalNumberFormatter){
        ...
        _decimalNumberFormatter.numberStyle = NSNumberFormatterNoStyle;
...
- (void)accessibilityIncrement {
  ...
  self.accessibilityValue = [NSString stringWithFormat:@"%@",slider.minLabel.string];
}
