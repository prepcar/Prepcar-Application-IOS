...
#import "AboutbuyerViewController.h"

@interface AboutbuyerViewController ()

@end

@implementation AboutbuyerViewController
...
-(void)aboutusmethod{
    NSString *urlString = @"http://autonana.com/admin/pages/aboutus";
