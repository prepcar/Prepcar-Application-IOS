...
- (void)buildFooterView {
    ...
    self.skipButton.frame = CGRectMake(0, 100, 80, 30);
    
    self.skipButton.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
    [self.skipButton setTitle:@"Start" forState:UIControlStateNormal];
    [self.skipButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self.skipButton addTarget:self action:@selector(skipIntroduction) forControlEvents:UIControlEventTouchUpInside];
    [self addSubview:self.skipButton];
    self.skipButton.hidden=YES;
    
//    UIButton *btnStart =[[UIButton alloc]initWithFrame:CGRectMake(self, 50, 200, 50)];
//    
//    btnStart.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
...
//    
//    UIViewController *viewController = [storyboard instantiateViewControllerWithIdentifier:@"LoginFirst"];
//    UINavigationController *navi = [[UINavigationController alloc] initWithRootViewController:viewController];
//    [navi pushViewController:navi animated:YES];
//    LoginViewController *driverDetailView;
//    [driverDetailView performSegueWithIdentifier:@"LoginFirst" sender:nil];
...
//{
//    if ([[segue identifier] isEqualToString:@"LoginFirst"])
//    {
////        SubCategaryViewController *obj = [segue destinationViewController];
////        obj.ayr_SelectedData =Selecteindx;
//    }
//}
