...
- (void) layoutSubviews
{
    ...
    rect1.origin.y = self.bounds.size.height - self.titlePositionY - self.imgPositionY - rect1.size.height+80;
...
- (void) buildUI {
    ...
    if (self.titleImageView == nil) {
        UIImageView *titleImageView = self.titleImage != nil ? [[UIImageView alloc] initWithImage:self.titleImage] : [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 350, 350)];
