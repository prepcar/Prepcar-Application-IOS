...
- (void)viewDidLoad {
    ...
    item.selectedImage = [[UIImage imageNamed:@"foot_white_icon_1"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    item.image=[[UIImage imageNamed:@"foot_home_icn"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    //item.title=@"Home";
    ...
    item1.selectedImage = [[UIImage imageNamed:@"foot_white_icon_2"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    item1.image=[[UIImage imageNamed:@"foot_calender_icn"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    //item1.title=@"Profile";
...
-(IBAction)pushback:(id)sender{
    ...
    [request101 setCompletionBlock:^{
        ...
        if ([[[responseArray valueForKey:@"status"] description] isEqualToString:@"1"]) {
            ...
            [self performSegueWithIdentifier:@"lognp" sender:nil];
            [[AppManager sharedManager] removeLoadingWindow];
        }
        else {
