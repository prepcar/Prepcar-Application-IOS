...
- (void)commonInit {
    ...
    _buttonTitleFont = [UIFont systemFontOfSize:12.0f];
    _cancelButtonTitleFont = [UIFont boldSystemFontOfSize:12.0f];
    _destructiveButtonTitleFont = [UIFont systemFontOfSize:12.0f];
